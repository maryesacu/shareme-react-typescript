...
import { FetchedUser, Pin } from '../types/sanityInterfaces'
import { userInfo } from 'os'

const PinDetail = (props: { user: FetchedUser }) =>
{
    ...
    return (
        <>
                ...
                <div className="flex flex-col justify-center items-center md:items-start flex-initial">
                    ...
                    <div className="w-full p-5 flex-1 xl:min-w-620">
                        ...
                        <div className="flex flex-wrap mt-6 gap-3">
                            ...
                            <input type="text" className='flex-1 border-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-300' placeholder='Add a comment' value={comment} onChange={(e: any) => setComment(e.target.value)} />
            ...
            ) : <p className='text-center'>No related pins</p>}
        </>
    )
}
